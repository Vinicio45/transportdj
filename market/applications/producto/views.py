...
from applications.users.mixins import AlmacenPermisoMixin, VentasPermisoMixin
#
...
class ProductListView(VentasPermisoMixin, ListView):
...
class ProductCreateView(VentasPermisoMixin, CreateView):
    template_name = "producto/form_producto.html"
    form_class = ProductForm
    success_url = reverse_lazy('producto_app:producto-lista')


class ProductUpdateView(VentasPermisoMixin, UpdateView):
    template_name = "producto/form_producto.html"
    model = Product
    form_class = ProductForm
    success_url = reverse_lazy('producto_app:producto-lista')
...
class ProductDeleteView(VentasPermisoMixin, DeleteView):
    template_name = "producto/delete.html"
    model = Product
    success_url = reverse_lazy('producto_app:producto-lista')


class ProductDetailView(VentasPermisoMixin, DetailView):
...
class ProductDetailViewPdf(VentasPermisoMixin, View):
...
class FiltrosProductListView(VentasPermisoMixin, ListView):
